    ...
    <div class="grid grid-cols-2 gap-0">
        ...
        <div class="w-full">
            <div class="form-center">
                <h1 class="mb-5 mt-0 text-4xl font-medium leading-tight text-primary text-center">Create your account</h1>
                ...
                <br />
                <button type="button" class="mx-auto block w-1/2 p-2.5 text-black bg-blue-300 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" v-on:click="signUp()">Register</button>
                <p class="mx-auto text-center block w-1/2 p-2.5 text-sm font-light text-gray-500 dark:text-gray-400">
                    Already have an account? 
                    <button class="font-medium text-primary-600 hover:underline dark:text-primary-500 text-blue-500" v-on:click="loginPage()">Login here
                    </button>
                </p>
